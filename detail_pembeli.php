...
<html lang="en">
    <head>
        ...
        <meta name="description" content="Detail Pembeli Buku" />
        <meta name="author" content="Blackrex" />
        <meta property="og:title" content="Detail Pembeli Buku" />
        <meta property="og:image" content="favicon_io/favicon.ico" />
        <meta property="og:url" content="https://stockbuku.com/detail_pembeli.php" />
    ...
    <body class="sb-nav-fixed">
        ...
        <nav class="sb-topnav navbar navbar-expand navbar-ligth bg-ligth">
            <a class="navbar-brand" href="detil_pembeli.php">Detil Pembeli</a>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Detil Pembeli</h1>
                        <div class="card mb-4">
                            <div class="card-header">
                                <button type="button" class="button-17" role="button" data-toggle="modal" data-target="#myModal">
                                    Import
                                </button>
                                <a href="exportdetail_pembeli.php" class="button-17" role="button" id="exportButton" >Export Data</a>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-hover" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                        <?php
                                        // Ambil semua data detil pembeli
                                        $queryDetilPembeli = $conn->prepare("SELECT dp.idpembeli, dp.idbuku, dp.qty, dp.harga, b.judulbuku, p.nama_pembeli FROM detil_pembeli dp JOIN buku b ON dp.idbuku = b.idbuku JOIN pembeli p ON dp.idpembeli = p.idpembeli");
                                        $queryDetilPembeli->execute();
                                        $resultDetilPembeli = $queryDetilPembeli->get_result();

                                        $i = 1;
                                        while ($data = $resultDetilPembeli->fetch_assoc()) {
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <h4 class="modal-title">Import data detil pembeli</h4>
                    ...
                    <form method="post" enctype="multipart/form-data">
                        <div class="modal-body">
                            <p>Silakan unggah file Excel untuk import data detil pembeli.</p>
