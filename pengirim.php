...
<html lang="en">
    <head>
        ...
        <meta name="description" content="Pengirim" />
        <meta name="author" content="Blackrex" />
        <meta property="og:title" content="Pengirim" />
        <meta property="og:image" content="favicon_io/favicon.ico" />
        <meta property="og:url" content="https://stockbuku.com/pengirim.php" />
        <meta name="twitter:card" content="summary_large_image" />
        <title>Pengirim</title>
    ...
    <body class="sb-nav-fixed">
        ...
        <nav class="sb-topnav navbar navbar-expand navbar-ligth bg-ligth">
            <a class="navbar-brand" href="pengirim.php">Pengirim</a>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Data Pengirim</h1>
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                <a href="exportpengirim.php" class="button-17" role="button" id="exportButton" >Export Data</a>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-hover" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            <?php
                                            $query = "
                                                SELECT p.tanggal_kirim, p.nobukti, pener.nama AS nama_pengirim
                                                FROM pengirim p 
                                            ...
                                            while ($data = $result->fetch_assoc()) {
                                                $tanggal_kirim = htmlspecialchars($data['tanggal_kirim'], ENT_QUOTES, 'UTF-8');
                                                $nobukti = htmlspecialchars($data['nobukti'], ENT_QUOTES, 'UTF-8');
                                                $nama_pengirim = htmlspecialchars($data['nama_pengirim'], ENT_QUOTES, 'UTF-8');
                                            ?>
                                            <tr>
                                                <td><?= $no++; ?></td>
                                                <td><?= $tanggal_kirim; ?></td>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h4 class="modal-title">Import data pengirim</h4>
                ...
                <form method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                        <p>Silakan unggah file Excel untuk import data pengirim.</p>
                        <input type="file" name="file_excel" accept=".xlsx, .xls" class="form-control" required>
                        <br>
                        <button type="submit" class="button-17" role="button" name="importDataPengirim">Import</button>
                    </div>
                </form>
            </div>
        </div>
